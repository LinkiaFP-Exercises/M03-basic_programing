...
public final class Pregunta {
	 ...
	 * {@code REGEX_WORD_SPACE_WORD} y solicita al usuario que ingrese un valor
	 * hasta que se proporcione una entrada que cumpla con el patrón especificado.
	 * 
	 * @see #REGEX_WORD_SPACE_WORD
	...
	public static String pidePalabra(String pregunta) {
		return validation(pregunta, REGEX_WORD_SPACE_WORD, ERROR_WORD_CARACTERS);
	}
	 ...
	 * funcion {@code pidePalabra}
	 * 
	 * @see #pidePalabra
	 */
	private static final String REGEX_WORD_SPACE_WORD = "^\\w+( \\w+)*$";

	/**
	 * String con mensaje de error para user cuando no cumple regex
	 * {@code REGEX_WORD_SPACE_WORD}
	 * 
	 * @see #REGEX_WORD_SPACE_WORD
	 */
	private static final String ERROR_WORD_CARACTERS = "Solo son permitidos caracteres a-z, A-Z, 0-9, _ y -";
}
